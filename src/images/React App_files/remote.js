...
L:"ytp-mdx-manual-pairing-popup-dialog",T:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",ba:"Het is binnenkort niet meer mogelijk je tv met het web te verbinden via een code"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",R:[{G:"button",ia:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],ba:"Meer informatie"},{G:"button",ia:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],ba:"OK"}]}]}]});this.u=new g.tM(this,
250);this.learnMoreButton=this.ha("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.ha("ytp-mdx-manual-pairing-popup-ok");g.C(this,this.u);this.P(this.learnMoreButton,"click",this.B);this.P(this.okButton,"click",this.C)},Y6=function(){g.U.call(this,{G:"div",
L:"ytp-mdx-popup-dialog",T:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-popup-title",ba:"Je bent uitgelogd"},{G:"div",L:"ytp-mdx-popup-description",ba:"Video's die je bekijkt, kunnen aan de kijkgeschiedenis van de tv worden toegevoegd en de aanbevelingen op de tv be\u00efnvloeden. Annuleer deze actie en log in bij YouTube op je computer om dit te voorkomen."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",R:[{G:"button",ia:["ytp-button","ytp-mdx-privacy-popup-cancel"],
ba:"Annuleren"},{G:"button",ia:["ytp-button","ytp-mdx-privacy-popup-confirm"],ba:"Bevestigen"}]}]}]});this.u=new g.tM(this,250);this.cancelButton=this.ha("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.ha("ytp-mdx-privacy-popup-confirm");g.C(this,this.u);this.P(this.cancelButton,"click",this.B);this.P(this.confirmButton,"click",this.C)},Z6=function(a){g.U.call(this,{G:"div",
...
c=g.T(b,128)?g.sK("Fout op $RECEIVER_NAME",c):b.Hb()||g.T(b,4)?g.sK("Wordt afgespeeld op $RECEIVER_NAME",c):g.sK("Verbonden met $RECEIVER_NAME",c);a.za("statustext",c);a.u.show()}else a.u.hide()},$6=function(a,b){g.sR.call(this,"Afspelen op",0,a,b);
...
this.gi={key:q4(),name:"Deze computer"};this.nh=null;this.subscriptions=[];this.Rz=this.wb=null;this.gm=[this.gi];this.ol=this.gi;this.Mc=new g.SK(64);this.dE=0;this.Pe=-1;this.np=null;this.ls=this.yu=!1;this.Ln=this.Mp=null;if(!g.DD(this.player.S())){a=this.player;var b=g.MN(a);b&&(b=b.Cl())&&(b=new $6(a,b),g.C(this,b));b=new Z6(a);g.C(this,b);g.WN(a,b.element,4);this.Mp=new Y6;g.C(this,this.Mp);g.WN(a,this.Mp.element,4);g.P(this.player.S().experiments,"pair_servlet_deprecation_warning_enabled")&&
...
$6.prototype.ji=function(a){return"cast-selector-receiver"===a?"Casten...":this.gm[a].name};
