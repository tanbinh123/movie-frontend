...
// const a = ['102', '201', '303', '401', '501', '602'];
...
fetch(`https://api.themoviedb.org/3/movie/406?api_key=33ea3e5328d23c13d33ed05add4783b7`)
...
fetch(`https://api.themoviedb.org/3/movie/406/videos?api_key=33ea3e5328d23c13d33ed05add4783b7&language=en-US`)
  .then(response => response.json())
  .then(movie => {
    setYoutube(movie.results[1].key);
  })
  
fetch(`http://webservice.fanart.tv/v3/movies/406?api_key=d74996a4a3d05c07a61abb08608a5974&client_key=52c813aa7b8c8b3bb87f4797532a2f8c`)
  .then(response => response.json())
  .then(result => {
